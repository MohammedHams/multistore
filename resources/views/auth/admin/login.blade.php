...
@section('auth_title', 'تسجيل الدخول - المشرف')
@section('auth_description', 'قم بتسجيل الدخول كمشرف للوصول إلى لوحة التحكم')
...
<form class="form w-100" method="POST" action="{{ route('admin.login.submit') }}">
    ...
    <div class="text-center mb-10">
        <!--begin::Title-->
        <h1 class="text-dark mb-3">{{ __('تسجيل دخول المشرف') }}</h1>
        <!--end::Title-->
    </div>
    <!--begin::Heading-->
