...
@section('auth_title', 'تسجيل الدخول - موظف المتجر')
@section('auth_description', 'قم بتسجيل الدخول كموظف متجر للوصول إلى لوحة التحكم')

@section('content')
<!--begin::Form-->
<form class="form w-100" method="POST" action="{{ route('store-staff.login.submit') }}">
    @csrf
    <!--begin::Heading-->
    <div class="text-center mb-10">
        <!--begin::Title-->
        <h1 class="text-dark mb-3">{{ __('تسجيل دخول موظف المتجر') }}</h1>
        <!--end::Title-->
    </div>
    <!--begin::Heading-->
