...
<head>
    <base href="">
    <title>@yield('title', 'Store Staff Dashboard - Multistore')</title>
    <meta name="description" content="@yield('meta_description', 'Store Staff Dashboard for Multistore')" />
    <meta name="keywords" content="@yield('meta_keywords', 'store staff, dashboard, multistore')" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta charset="utf-8" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="@yield('og_title', 'Store Staff Dashboard - Multistore')" />
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            <!--begin::Aside-->
            @include('layouts.partials.store-staff-sidebar')
            <!--end::Aside-->
            <!--begin::Wrapper-->
                ...
                <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
                    ...
                    <div class="container-fluid d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <small class="text-muted fs-6 fw-normal ms-1">@yield('page_subtitle', 'Store Staff Panel')</small></h1>
                            <!--end::Heading-->
                        </div>
                        <!--end::Page title=-->
                        <!--begin::Wrapper-->
                        ...
                        <div class="d-flex align-items-center flex-shrink-0">
                            ...
                            <div class="d-flex align-items-center ms-3 ms-lg-4" id="kt_header_user_menu_toggle">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="d-flex flex-column">
                                                <div class="fw-bolder d-flex align-items-center fs-5">{{ Auth::guard('store-staff')->user()->name }}</div>
                                                <a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{ Auth::guard('store-staff')->user()->email }}</a>
                                            </div>
                                            <!--end::Username-->
                                        </div>
                                    </div>
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-5">
                                        <form method="POST" action="{{ route('store-staff.logout') }}" id="logout-form">
                                            @csrf
                                            <a href="{{ route('store-staff.logout') }}" class="menu-link px-5" 
