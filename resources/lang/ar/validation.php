...
return [
    ...
    */
    ...
    'required_array_keys' => 'الحقل :attribute يجب أن يحتوي على مفاتيح للقيم التالية: :values.',
    ...
    'required_with' => 'حقل :attribute مطلوب عند توفّر :values.',
    'required_with_all' => 'حقل :attribute مطلوب عند توفّر :values.',
    'required_without' => 'حقل :attribute مطلوب عند عدم توفّر :values.',
    'required_without_all' => 'حقل :attribute مطلوب عند عدم توفّر :values.',
    ...
    */
    ...
    'custom' => [
        ...
        'phone' => [
            ...
            'digits' => 'يجب أن يتكون رقم الهاتف من :digits رقمًا.',
        ],
        'domain' => [
            'required' => 'حقل النطاق مطلوب.',
            'string' => 'يجب أن يكون النطاق نصًا.',
            'unique' => 'هذا النطاق مستخدم بالفعل.',
        ],
        'logo' => [
            'image' => 'يجب أن يكون الشعار صورة.',
            'mimes' => 'يجب أن يكون الشعار من نوع: :values.',
            'max' => 'يجب ألا يتجاوز حجم الشعار :max كيلوبايت.',
        ],
        'permissions' => [
            'required' => 'يجب تحديد صلاحية واحدة على الأقل.',
            'array' => 'يجب أن تكون الصلاحيات مصفوفة.',
        ],
        'user_id' => [
            'required' => 'يجب تحديد المستخدم.',
            'exists' => 'المستخدم المحدد غير موجود.',
        ],
        'store_id' => [
            'required' => 'يجب تحديد المتجر.',
            'exists' => 'المتجر المحدد غير موجود.',
        ],
    ],
