...
Route::middleware(['auth', 'verified', 'admin'])->group(function () use ($storeController, $storeOwnerController, $storeStaffController) {
    // Store Management
...
Route::middleware(['auth', 'verified', 'admin'])->prefix('admin')->group(function () use ($storeController, $storeOwnerController, $storeStaffController) {
    // Store Management
...
Route::middleware(['auth', 'verified', 'store-owner'])->prefix('store-owner')->group(function () use ($storeController, $storeStaffController) {
...
Route::middleware(['auth', 'verified', 'store-staff'])->prefix('store-staff')->group(function () use ($storeController) {
    // Store Management (limited to view only)
