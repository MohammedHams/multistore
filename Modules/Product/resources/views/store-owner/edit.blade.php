        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('store-owner.product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            @if ($product->image)
                                <div class="mb-2">
                                    <img src="{{ $product->image }}" alt="{{ $product->name }}" width="100" class="img-thumbnail">
                                </div>
                            @endif
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <a href="{{ route('store-owner.product.index') }}" class="btn btn-secondary">إلغاء</a>
                        </div>
                    </form>
                </div>
            </div>
