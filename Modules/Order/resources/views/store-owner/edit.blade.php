            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <a href="{{ route('store-owner.order.show', $order->id) }}" class="btn btn-info btn-sm">عرض التفاصيل</a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('store-owner.order.update', $order->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('store-owner.order.show', $order->id) }}" class="btn btn-secondary">إلغاء</a>
