        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('store-owner.order.create') }}" class="btn btn-primary btn-sm">إنشاء طلب</a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <form action="{{ route('store-owner.order.index') }}" method="GET" class="row g-3">
                            <div class="col-md-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('store-owner.order.show', $order->id) }}" class="btn btn-info btn-sm">عرض</a>
                                                <a href="{{ route('store-owner.order.edit', $order->id) }}" class="btn btn-primary btn-sm">تعديل</a>
                                                <form action="{{ route('store-owner.order.destroy', $order->id) }}" method="POST" class="d-inline" onsubmit="return confirm('هل أنت متأكد أنك تريد حذف هذا الطلب؟');">
                                                    @csrf
                                                    @method('DELETE')
